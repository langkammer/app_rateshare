...
public class PostItemTouchHelperCallback extends ItemTouchHelper.Callback {
    private final ListaPostsAdapter adapter;

    public PostItemTouchHelperCallback(ListaPostsAdapter adapter) {
